    ...
    <div className="py-12 bg-[#A0BBA7]">
      ...
      >
        <p className="text-gray-700 leading-relaxed italic text-sm md:text-base text-center">
          &ldquo;Mình rất hài lòng với dịch vụ custom của RECO! Mình đã gửi
          chiếc áo cũ đến và yêu cầu thêm một số chi tiết cá nhân hóa. Khi nhận
          lại, mình thực sự bất ngờ với chất lượng. Sản phẩm không chỉ đẹp mà
          còn hoàn toàn phù hợp với phong cách của mình. RECO đã làm cho chiếc
          áo trở nên mới mẻ và độc đáo, lại còn rất thoải mái khi mặc. Thật
          tuyệt vời khi được cùng RECO đóng góp vào việc bảo vệ môi trường! Mình
