      ...
      >
        <div className="bg-gradient-to-r from-pink-300 to-purple-700 p-6 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center">
            ...
            >
              <h1 className="text-3xl font-bold tracking-tight">{user?.user?.username}</h1>
              <div className="flex items-center mt-2 space-x-2">
                <span className="bg-white/20 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1 rounded-full">
                  {user?.user?.role}
                </span>
                <span className="text-sm text-white/90">Member since {new Date().getFullYear()}</span>
              </div>
            </motion.div>
          </div>
            ...
            >
              ...
              {isEditing ? (
                ...
                <>
                  <div className="bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition">
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Email</p>
                    <p className="font-medium text-gray-800 mt-1">{user?.user?.email || 'Not provided'}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition">
                    <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Phone</p>
                    <p className="font-medium text-gray-800 mt-1">{user?.user?.phone || 'Not provided'}</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition">
            ...
            >
              ...
              {isEditing ? (
                ...
                <div className="bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition">
                  ...
                  <p className="font-medium text-gray-800 mt-1">{user?.user?.address || 'Not provided'}</p>
                </div>
              )}
              
              <div className="bg-gray-50 p-4 rounded-lg hover:bg-gray-100 transition">
                <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">User ID</p>
                <p className="font-mono text-sm text-gray-600 mt-1">{user?.user?._id}</p>
              </div>
